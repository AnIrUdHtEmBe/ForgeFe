    ...
    <div className="landing-container">
      ...
      <main className="landing-main">
        ...
        <p className="subheading">
          Explore courts and book sessions in <strong>Sports</strong>,{" "}
          <strong>Fitness</strong>, and <strong>Wellness</strong> — all in one
          place.
        </p>
        ...
        <div className="category-cards">
          <div className="card">
            <img
              src="https://image.shutterstock.com/image-vector/sports-set-athletes-various-disciplines-260nw-1349779070.jpg"
              alt="Sports"
            />
      ...
      {loginModal && (
        <LoginV2
          handleModal={handleLoginClick}
          registermodal={handleRegisterClick}
        ></LoginV2>
      )}
      {registerModal && (
        <Register
          handleModal={handleRegisterClick}
          loginmodal={handleLoginClick}
        ></Register>
      )}
    </div>
  );
